...
/*app.route('/chatrooms')
 ...
 .get(users.requiresLogin, chatrooms.isInChat, chatrooms.read)
 .put(users.requiresLogin, chatrooms.isInChat, chatrooms.update)
 .delete(users.requiresLogin, chatrooms.isInChat, chatrooms.delete);
/**
