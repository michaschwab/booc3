    ...
    this.findAddPaths = function(provs, layer, groupClassName, pathClassName, markerNormal, markerColored, each)
    {
        provs.forEach(function(dep, i)
        {
            ...
            if(from && to)
            {
                ...
                var lines = MapArrowShaping.curvePath(pathNode, pos, [from, to], $scope.visParams.scale, $scope.getTranslateAbs, 0, 3, undefined, undefined, dep, $scope.graphWidth, $scope.graphHeight);
