...
/*
app.route('/sources')
 .get(users.requiresLogin, sources.list)
 .post(users.requiresLogin, users.isAnyContentEditor, sources.isCourseContentEditor, sources.create);

 app.route('/sources/:sourceId')
 .get(users.requiresLogin, sources.read)
 .put(users.requiresLogin, users.isAnyContentEditor, sources.isCourseContentEditor, sources.update)
 .delete(users.requiresLogin, users.isAnyContentEditor, sources.isCourseContentEditor, sources.delete);
