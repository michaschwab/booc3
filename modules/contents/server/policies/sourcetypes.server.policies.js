...
/*
 ...
 .get(users.isAnyTa, sourcetype.list)
 .post(users.requiresLogin, users.isAdmin, sourcetype.create);

 app.route('/sourcetypes/:sourcetypeId')
 .get(users.requiresLogin, sourcetype.read)
 .put(users.requiresLogin, users.isAdmin, sourcetype.update)
 .delete(users.requiresLogin, users.isAdmin, sourcetype.delete);
    */
