...
/*
 ...
 .get(users.requiresLogin, learnedconcepts.list)
 .post(users.requiresLogin, learnedconcepts.create);

 app.route('/learnedconcepts/:learnedconceptId')
 .get(users.requiresLogin, users.isAdminOrSelf, learnedconcepts.read)
 .put(users.requiresLogin, users.isAdminOrSelf, learnedconcepts.update)
 .delete(users.requiresLogin, users.isAdminOrSelf, learnedconcepts.delete);
